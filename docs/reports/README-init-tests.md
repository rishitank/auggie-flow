...
This directory contains comprehensive tests for the `auggie-flow init` command, covering all aspects of project initialization including basic setup, SPARC integration, error handling, and performance validation.
