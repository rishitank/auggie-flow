# Auggie Flow v2.0.0 - Complete MCP Tools Reference

## 🎯 Overview

This document provides comprehensive documentation for all 87 MCP tools available in Auggie Flow v2.0.0, including ruv-swarm integration tools and native Auggie Flow capabilities.
...
**Example Usage:**
```bash
npx auggie-flow@2.0.0 coordination swarm-status
```
...
**Example Usage:**
```bash
npx auggie-flow@2.0.0 coordination agent-list
```
...
**Example Usage:**
```bash
npx auggie-flow@2.0.0 performance report \
  --timeframe 24h \
  --format detailed
```
...
**Example Usage:**
```bash
npx auggie-flow@2.0.0 bottleneck analyze \
...
**Example Usage:**
```bash
npx auggie-flow@2.0.0 workflow create \
...
**Example Usage:**
```bash
npx auggie-flow@2.0.0 github repo-analyze \
...
**Example Usage:**
```bash
npx auggie-flow@2.0.0 daa agent-create \
...
**Example Usage:**
```bash
npx auggie-flow@2.0.0 health-check \
...
# Execute workflow
npx auggie-flow@2.0.0 workflow execute \
  --workflow-id "workflow_20250706_141350"
```

This comprehensive MCP tools reference provides detailed documentation for all 87 tools available in Auggie Flow v2.0.0, enabling developers to leverage the full power of intelligent coordination and neural-enhanced development workflows.