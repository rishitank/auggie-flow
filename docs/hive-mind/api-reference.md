...
```javascript
const { HiveMind, MockAgent } = require('auggie-flow/testing');
...
```javascript
const { TestHarness } = require('auggie-flow/testing');
...
- Examples: https://github.com/ruvnet/auggie-flow/examples