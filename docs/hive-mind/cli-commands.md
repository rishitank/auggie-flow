...
npx auggie-flow@2.0.0 hive-mind --task "Build REST API" --complexity high

# Custom configuration
npx auggie-flow@2.0.0 hive-mind --agents 8 --topology mesh --no-wizard
```
...
```bash
npx auggie-flow@2.0.0 hive-mind init [options]
```
...
npx auggie-flow@2.0.0 hive-mind init

# Advanced setup
npx auggie-flow@2.0.0 hive-mind init --topology hierarchical --max-agents 12 --neural
```
...
```bash
npx auggie-flow@2.0.0 hive-mind task <description> [options]
```
...
```bash
# Simple task
npx auggie-flow@2.0.0 hive-mind task "Create user authentication system"

# Complex task with options
npx auggie-flow@2.0.0 hive-mind task "Migrate database to PostgreSQL" \
...
```bash
npx auggie-flow@2.0.0 hive-mind agents <action> [options]
```
...
```bash
# List all agents
npx auggie-flow@2.0.0 hive-mind agents list

# Spawn specialized agent
npx auggie-flow@2.0.0 hive-mind agents spawn --type coder --name "API-Expert"

# Check agent metrics
npx auggie-flow@2.0.0 hive-mind agents metrics --id coder-001
```
...
```bash
npx auggie-flow@2.0.0 hive-mind swarm <action> [options]
```
...
```bash
# Check swarm status
npx auggie-flow@2.0.0 hive-mind swarm status

# Optimize for current task
npx auggie-flow@2.0.0 hive-mind swarm optimize

# Scale to 10 agents
npx auggie-flow@2.0.0 hive-mind swarm scale --target 10
```
...
```bash
npx auggie-flow@2.0.0 hive-mind orchestrate [options]
```
...
npx auggie-flow@2.0.0 hive-mind orchestrate \
  --strategy parallel \
  --dependencies \
  --priority high
...
```bash
npx auggie-flow@2.0.0 hive-mind workflow <action> [options]
```
...
```bash
# Create workflow
npx auggie-flow@2.0.0 hive-mind workflow create \
  --name "full-stack-dev" \
  --steps "design,implement,test,deploy"

# Run saved workflow
npx auggie-flow@2.0.0 hive-mind workflow run full-stack-dev

# Export workflow
npx auggie-flow@2.0.0 hive-mind workflow export full-stack-dev --format json
```
...
```bash
npx auggie-flow@2.0.0 hive-mind memory <action> [options]
```
...
```bash
# Check memory status
npx auggie-flow@2.0.0 hive-mind memory status

# Search for patterns
npx auggie-flow@2.0.0 hive-mind memory search --pattern "authentication"

# Backup current state
npx auggie-flow@2.0.0 hive-mind memory backup --path ./hive-backup.json
```
...
```bash
npx auggie-flow@2.0.0 hive-mind learn <action> [options]
```
...
npx auggie-flow@2.0.0 hive-mind learn train --data ./success-patterns.json

# Analyze task patterns
npx auggie-flow@2.0.0 hive-mind learn analyze --task "API development"

# Predict optimal approach
npx auggie-flow@2.0.0 hive-mind learn predict --task "Build chat app"
```
...
```bash
npx auggie-flow@2.0.0 hive-mind monitor [options]
```
...
```bash
# Basic monitoring
npx auggie-flow@2.0.0 hive-mind monitor
...
# Web dashboard
npx auggie-flow@2.0.0 hive-mind monitor --dashboard
```
...
```bash
npx auggie-flow@2.0.0 hive-mind report <type> [options]
```
...
```bash
# Performance report
npx auggie-flow@2.0.0 hive-mind report performance --timeframe 24h

# Agent activity report
npx auggie-flow@2.0.0 hive-mind report agents --format detailed

# Task summary
npx auggie-flow@2.0.0 hive-mind report tasks --export ./task-report.pdf
```
...
```bash
npx auggie-flow@2.0.0 hive-mind config <action> [options]
```
...
```bash
# View all settings
npx auggie-flow@2.0.0 hive-mind config list

# Set max agents
npx auggie-flow@2.0.0 hive-mind config set max-agents 12

# Export configuration
npx auggie-flow@2.0.0 hive-mind config export --path ./hive-config.json
```
...
```bash
npx auggie-flow@2.0.0 hive-mind integrate <service> [options]
```
...
```bash
# GitHub integration
npx auggie-flow@2.0.0 hive-mind integrate github --repo owner/repo

# Slack notifications
npx auggie-flow@2.0.0 hive-mind integrate slack --webhook <url>
```
...
```bash
npx auggie-flow@2.0.0 hive-mind analyze <task> [options]
```
...
```bash
# Basic analysis
npx auggie-flow@2.0.0 hive-mind analyze "Build e-commerce platform"

# Detailed analysis
npx auggie-flow@2.0.0 hive-mind analyze "Migrate to microservices" \
  --detailed \
  --suggest-agents \
  --estimate-time
```
...
```bash
npx auggie-flow@2.0.0 hive-mind template <action> [options]
```
...
```bash
# List templates
npx auggie-flow@2.0.0 hive-mind template list

# Use REST API template
npx auggie-flow@2.0.0 hive-mind template use rest-api --name "MyAPI"

# Create custom template
npx auggie-flow@2.0.0 hive-mind template create --name "my-template"
```
...
npx auggie-flow@2.0.0 hive-mind init --topology hierarchical --max-agents 12

# 2. Create workflow
npx auggie-flow@2.0.0 hive-mind workflow create --name "enterprise-app"

# 3. Run with monitoring
npx auggie-flow@2.0.0 hive-mind workflow run enterprise-app --monitor

# 4. Generate report
npx auggie-flow@2.0.0 hive-mind report summary --export ./project-report.pdf
```
...
```bash
# In CI/CD pipeline
npx auggie-flow@2.0.0 hive-mind task "$BUILD_TASK" \
  --non-interactive \
...
# Sync agents
npx auggie-flow@2.0.0 hive-mind swarm sync

# Reset if needed
npx auggie-flow@2.0.0 hive-mind swarm reset
```

### Performance Issues
```bash
# Run diagnostics
npx auggie-flow@2.0.0 hive-mind monitor --metrics "bottlenecks"

# Optimize topology
npx auggie-flow@2.0.0 hive-mind swarm optimize

# Scale agents
npx auggie-flow@2.0.0 hive-mind swarm scale --target 6
```
