...
auggie-flow task create development "Implement authentication" \
  --priority 80 \
...
## Integration with Auggie Code Batch Tools

The task management system is designed to work seamlessly with Auggie Code's batch tools:
