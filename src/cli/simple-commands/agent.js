...
async function listAgents(subArgs, flags) {
  ...
  console.log('\nTo create agents:');
  console.log('  auggie-flow agent spawn researcher --name "ResearchBot"');
  console.log('  auggie-flow agent spawn coder --name "CodeBot"');
  console.log('  auggie-flow agent spawn analyst --name "DataBot"');
}
...
async function manageHierarchy(subArgs, flags) {
  ...
  switch (hierarchyCmd) {
    ...
    default:
      ...
      console.log('  auggie-flow agent hierarchy create enterprise');
      console.log('  auggie-flow agent hierarchy show');
  }
}
...
function showAgentHelp() {
  ...
  console.log();
  console.log('Examples:');
  console.log('  auggie-flow agent spawn researcher --name "DataBot"');
  console.log('  auggie-flow agent list --verbose');
  console.log('  auggie-flow agent hierarchy create enterprise');
  console.log('  auggie-flow agent ecosystem status');
}
