...
const METRICS_DIR = path.join(process.cwd(), '.auggie-flow', 'metrics');
...
<html>
<head>
  <title>Auggie Flow Performance Report - ${new Date().toISOString()}</title>
  <style>
...
<body>
  <div class="container">
    <h1>Auggie Flow Performance Report</h1>
