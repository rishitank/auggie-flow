...
async function createInteractiveConfig(outputFile) {
  ...
  try {
    ...
    console.log(`4. Run: auggie-flow init --config ${outputFile}`);
  } catch (error) {
...
function showBatchManagerHelp() {
  ...
  console.log('USAGE:');
  console.log('  auggie-flow batch <command> [options]\n');
  ...
  console.log('  auggie-flow batch create-config my-batch.json');
  console.log('  auggie-flow batch create-config --interactive');
  console.log('  auggie-flow batch validate-config my-batch.json');
  console.log('  auggie-flow batch estimate my-batch.json');
  console.log('  auggie-flow batch list-templates');
  console.log('  auggie-flow batch list-environments\n');

  console.log('INTEGRATION:');
  console.log('  Use created configs with: auggie-flow init --config <file>');
  console.log('  Or batch init directly: auggie-flow init --batch-init project1,project2');
}
