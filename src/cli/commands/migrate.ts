...
export function createMigrateCommand(): Command {
  ...
  command
    .description('Migrate existing auggie-flow projects to optimized prompts')
...
async function showMigrationStatus(projectPath: string): Promise<void> {
  ...
  if (!analysis.hasOptimizedPrompts) {
    console.log(chalk.bold('\n💡 Recommendations:'));
    console.log('  • Run migration analysis: auggie-flow migrate analyze');
    console.log('  • Start with dry run: auggie-flow migrate --dry-run');
    console.log('  • Use selective strategy: auggie-flow migrate --strategy selective');
  }
