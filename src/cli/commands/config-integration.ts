 ...
 * specifically for ruv-swarm integration with Auggie Code.
 */
...
function showConfigIntegrationHelp() {
  ...
  console.log('Usage:');
  console.log('  auggie-flow config-integration <command> [options]\\n');
  ...
  console.log('  auggie-flow config-integration setup --enable-ruv-swarm');
  console.log('  auggie-flow config-integration preset development');
  console.log('  auggie-flow config-integration sync --force');
  console.log('  auggie-flow config-integration export my-config.json');
  console.log('  auggie-flow config-integration status --verbose');
}
