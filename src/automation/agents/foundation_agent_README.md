...
npx auggie-flow@alpha hooks pre-task --description "Foundation building"

# Post-edit notifications
npx auggie-flow@alpha hooks post-edit --file "model.pkl"

# Memory storage
npx auggie-flow@alpha memory store "agent/foundation/results" "{...}"

# Result sharing
npx auggie-flow@alpha hooks notify --message "Foundation complete"
```
