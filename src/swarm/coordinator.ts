...
Ensure your implementation is complete, well-structured, and follows best practices.`,
  ...
  private async executeTaskWithAgent(task: TaskDefinition, agent: AgentState): Promise<any> {
    ...
    try {
      // Use Auggie Flow executor for full SPARC system in non-interactive mode
      const { ClaudeFlowExecutor } = await import('./auggie-flow-executor.ts');
    ...
    try {
      ...
      const command = new Deno.Command('claude', {
        ...
        env: {
          ...
          AUGGIE_SWARM_MODE: 'true',
          AUGGIE_SWARM_ID: this.swarmId.id,
          AUGGIE_TASK_ID: task.id.id,
          AUGGIE_AGENT_ID: agent.id.id,
          AUGGIE_WORKING_DIRECTORY: targetDir || process.cwd(),
          AUGGIE_FLOW_MEMORY_ENABLED: 'true',
          AUGGIE_FLOW_MEMORY_NAMESPACE: `swarm-${this.swarmId.id}`,
        },
        stdin: 'null',
        stdout: 'piped',
        stderr: 'piped',
...
// Generated by Auggie Flow Swarm

console.log('Hello, World!');
console.log('This application was created by the Auggie Flow Swarm system.');
...
`;
      ...
      const packageJson = {
        name: 'hello-world',
        version: '1.0.0',
        description: 'Hello World application created by Auggie Flow Swarm',
        main: 'index.js',
        scripts: {
          start: 'node index.js',
          test: 'node test.js',
        },
        keywords: ['hello-world', 'swarm', 'auggie-flow'],
        author: 'Auggie Flow Swarm',
        license: 'MIT',
      };
...
This application was created by the Auggie Flow Swarm system.
...
## Overview
This documentation was generated by the Auggie Flow Swarm system.
